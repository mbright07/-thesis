                                ...
                                @if (Route::has('login'))
                                        ...
                                        @if (Auth::user()->role_id === 1)
                                            <li class="menu-item menu-item-has-children parent">
                                                ...
                                                <ul class="submenu curency">
                                                    <li class="menu-item">
                                                        <a title="Dashboard"
                                                            href="{{ route('admin.dashboard') }}">{{ __('base.dashboard') }}</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a title="Categories"
                                                    ...
                                                    <li class="menu-item">
                                                        <a title="Contact Messages"
                                                            href="{{ route('admin.contact') }}">{{ __('base.contact_messages') }}</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a title="Settings"
                                                            href="{{ route('admin.settings') }}">{{ __('base.settings') }}</a>
                                                    </li>
                                                    <li class="menu-item">
                                        ...
                                        @else
                                            <li class="menu-item menu-item-has-children parent">
                                                ...
                                                <ul class="submenu curency">
                                                    ...
                                                    <li class="menu-item">
                                                        <a title="Change Password"
                                                            href="{{ route('user.changepassword') }}">{{ __('base.change_password') }}</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a title="Logout" href="{{ route('logout') }}"
                                                            onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{ __('base.logout') }}</a>
                                    ...
                                    @else
                                        <li class="menu-item"><a title="Register or Login"
                                                href="{{ route('login') }}">{{ __('base.login') }}</a></li>
                                        <li class="menu-item"><a title="Register or Login"
                                        ...
                                        <ul class="submenu lang">
                                            ...
                                            <li class="menu-item"><a title="Japanese"
                                                    href="{!! route('change-language', ['ja']) !!}"><span class="img label-before"><img
                                                            src="/assets/images/lang-jp.jpg"
                                                            alt="lang-ja"></span>{{ __('base.japan') }}</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
