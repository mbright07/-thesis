                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('employer.recruitments') }}" class="btn btn-success pull-right">{{ __('admin/admin-recruitment.all_recruitments') }} </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <ul class="products-cart">
                                @foreach ($recruitment->recruitmentJob as $item )
                                    <li class="pr-cart-item">
                                        ...
                                        <div class="price-field sub-total"><p class="price"><a href="{{ route('employer.review.candidate',['recruitment_job_id'=>$item->id]) }}">{{ __('user/user-recruitment.write_review') }}</a></p></div>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
