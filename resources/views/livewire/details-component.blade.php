                                                    ...
                                                    <div id="comment-20" class="comment_container"> 
                                                        ...
                                                        <div class="comment-text">
                                                            ...
                                                            <p class="meta"> 
                                                                ...
                                                                <time class="woocommerce-review__published-date" datetime="2008-02-14 20:00" >{{ Carbon\Carbon::parse($recruitmentJob->review->created_at)->format('d F Y g:i A') }}</time>
                                                            </p>
                                ...
                                <li class="product-item">
                                    <div class="product product-widget-style">
                                        <div class="thumbnnail">
                                            <a href="{{ route('job.details', ['slug'=>$popular_job->slug]) }}" title="{{ $popular_job->name }}">
                                                <figure><img src="{{asset('assets/images/products/')}}/{{ $popular_job->image }}" alt="{{ $popular_job->name }}"></figure>
                                            </a>
                                        </div>
                            ...
                            @foreach ($related_jobs as $related_job)
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{ route('job.details', ['slug'=>$related_job->slug]) }}" title="{{ $related_job->name }}">
