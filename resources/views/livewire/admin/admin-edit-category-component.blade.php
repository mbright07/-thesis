                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('admin.categories') }}"
                                    class="btn btn-success pull-right">{{ __('admin/admin-edit-category.all_locations') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="updateCategory">
                            ...
                            @if ($this->sub_category_id)
                                <div class="form-group">
                                    <label for=""
                                        class="col-md-4 control-label">{{ __('admin/admin-edit-category.parent_location') }}</label>
                                    <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <button type="submit"
                                        class="btn btn-primary">{{ __('admin/admin-edit-category.update') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
