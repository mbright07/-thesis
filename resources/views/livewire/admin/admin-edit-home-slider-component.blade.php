                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="updateSlide">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="{{ __('admin/admin-add-home-slider.salary') }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    @else
                                        <img src="{{ asset('assets/image/sliders') }}/{{ $image }}"
                                            width="120" />
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <button type="submit"
                                        class="btn btn-primary">{{ __('admin/admin-add-home-slider.update') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
