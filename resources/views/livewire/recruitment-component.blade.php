                            ...
                            <div class="billing-address">
                                <form enctype="multipart/form-data" wire:submit.prevent="placeRecruitment" onsubmit="$('#processing').show();"> 
                                    <div class="form-group row-in-form">
                                        ...
                                        <input type="text" name="fname" value="" placeholder="{{ __('recruitment.f_name') }}" wire:model="firstname">
                                        @error('firstname') <p class="text-danger">{{ $message }}</p> @enderror
                                    </div>
                                    <div class="form-group row-in-form">
                                        <label for="lname">{{ __('recruitment.l_name') }}<span>*</span></label>
                                        <input  type="text" name="lname" value="" placeholder="{{ __('recruitment.l_name') }}" wire:model="lastname">
                                        @error('lastname') <p class="text-danger">{{ $message }}</p> @enderror
                                    </div>
                                    <div class="form-group row-in-form">
                                        <label for="email">{{ __('recruitment.email') }}<span>*</span></label>
                                        <input type="email" name="email" value="" placeholder="{{ __('recruitment.email') }}" wire:model="email">
                                        @error('email') <p class="text-danger">{{ $message }}</p> @enderror
                                    </div>
                                    <div class="form-group row-in-form">
                                        <label for="phone">{{ __('recruitment.mobile') }}<span>*</span></label>
                                        <input type="number" name="phone" value="" placeholder="{{ __('recruitment.10') }}" wire:model="mobile">
                                        @error('mobile') <p class="text-danger">{{ $message }}</p> @enderror
                                    </div>
                                    <div class="form-group row-in-form">
                                        <label for="add">{{ __('recruitment.intro') }}<span>*</span></label>
                                        {{-- <textarea id="comment" name="add" cols="78" rows="8" wire:model="intro"></textarea> --}}
                                        <input type="text" name="add" value="" placeholder="{{ __('recruitment.intro') }}" wire:model="intro">
                                        @error('intro') <p class="text-danger">{{ $message }}</p> @enderror
                                    </div>
                                    <div class="form-group row-in-form">
                                        <label for="country">{{ __('recruitment.country') }}<span>*</span></label>
                                        <input type="text" name="country" value="" placeholder="{{ __('recruitment.country') }}" wire:model="country">
                                        @error('country') <p class="text-danger">{{ $message }}</p> @enderror
                                    </div>
                                    <div class="form-group row-in-form">
                                        <label for="province">{{ __('recruitment.province') }}<span>*</span></label>
                                        <input type="text" name="province" value="" placeholder="{{ __('recruitment.province') }}" wire:model="province">
                                        @error('province') <p class="text-danger">{{ $message }}</p> @enderror
                                    </div>
                                    <div class="form-group row-in-form">
                                        <label for="city">{{ __('recruitment.city') }}<span>*</span></label>
                                        <input type="text" name="city" value="" placeholder="{{ __('recruitment.city') }}" wire:model="city">
                                    ...
                                    <div class="summary-item payment-method">
                                        <button type="submit" class="btn btn-medium">{{ __('recruitment.apply_now') }}</button>
                                    </div> 
                                </form>   
                            </div>                        
                        </div>
