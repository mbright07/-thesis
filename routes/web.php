...
use App\Http\Livewire\Employer\EmployerAddJobComponent;
use App\Http\Livewire\Employer\EmployerDashBoardComponent;
use App\Http\Livewire\Employer\EmployerEditJobComponent;
use App\Http\Livewire\Employer\EmployerJobComponent;
...
Route::group(['middleware' => 'locale'], function () {
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::group(['middleware' => 'role:employer'], function () {
            ...
            Route::get('/employer/jobs', EmployerJobComponent::class)->name('employer.jobs');
            Route::get('/employer/job/add', EmployerAddJobComponent::class)->name('employer.addjob');
            Route::get('/employer/job/edit/{job_slug}', EmployerEditJobComponent::class)->name('employer.editjob');
        });
